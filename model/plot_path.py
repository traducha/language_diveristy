...
with open('/home/tomaszraducha/Dropbox/DaneAxelrod/mgr/mgr/path/cluster_paths_q2_av200.data', 'rb') as _file:
...
with open('/home/tomaszraducha/Dropbox/DaneAxelrod/mgr/mgr/path/high_k_cluster_paths_q2_av200.data', 'rb') as _file:
    path = pickle.load(_file)
